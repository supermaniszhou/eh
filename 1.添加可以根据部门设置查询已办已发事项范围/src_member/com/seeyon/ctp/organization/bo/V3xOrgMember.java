...
public class V3xOrgMember extends V3xOrgEntity implements Serializable {
    ...
    private int state = OrgConstants.MEMBER_STATE.ONBOARD.ordinal();                                   //姓名对应的国际化id
    ...
    public V3xOrgMember(V3xOrgMember orgMember) {
        ...
        this.name = orgMember.getFullName();
        this.i18nNameId = orgMember.getI18nNameId();
    ...
    public V3xOrgMember fromVisitorPO(OrgVisitor visitor) {
        ...
        this.isVisitor = true;
        this.orgAccountId = visitor.getOrgAccountId();
        this.enabled = visitor.getState() == OrgConstants.VISITOR_STATE.NORMAL.ordinal();
        return this;
    }
    ...
    public BasePO toPO() {
        ...
        o.setCode(this.code);
        o.setName(this.name);
        o.setI18nNameId(this.i18nNameId);
    ...
    public String getName() {
        if (OrgConstants.GUEST_ID.equals(this.id)) {
...
//					}
    ...
    class V3xOrgMemberImmutableDecorator extends V3xOrgMember {
        ...
        public java.lang.Long getI18nNameId() {
            return this.source.getI18nNameId();
        }
